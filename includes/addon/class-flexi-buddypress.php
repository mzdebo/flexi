...
class Flexi_Addon_BuddyPress
{
 ...
 public function add_fields($new)
 {
  ...
  $fields = array('flexi_buddypress_settings' => array(
   array(
    ...
    'description'       => __('Displays tab on user profile page of BuddyPress members page.', 'flexi'),
    'type'              => 'checkbox',
 ...
 public function flexi_buddypress_yourtab_screen()
 {
  ...
  // add_action('bp_template_title', 'flexi_buddypress_yourtab_title');
  // add_action('bp_template_content', 'flexi_buddypress_yourtab_content');
